...
function Viewport() {
    ...
    this.fromContentString = function(a) {
        for (var a = a.split(","), b, d, e = 0; e < a.length; e++) b = a[e].split("="), 2 === b.length && (d = b[0].trim(), b = b[1].trim(), isNaN(parseFloat(b)) || (b = parseFloat(b)), "width" === d ? this.width = b : "height" === d ? this.height = b : "initial-scale" === d ? this.initialScale = b : "maximum-scale" === d ? this.maxScale = b : "minimum-scale" ===
            d ? this.minScale = b : "user-scalable" === d && (this.bUserScalable = "no" === b ? !1 : !0))
    };
    ...
    this.update = function(a, b) {
        ...
        if (d.bSupported) {
            ...
            e = d.prevWidth;
            "device-width" === e ? e = d.screenWidth : void 0 ===
                e && (e = document.documentElement.clientWidth);
            d.updateMeta();
...
function ReView() {
    ...
    this.ready = function() {
        var a = document.getElementsByClassName("reView"),
            ...
            d = reView;
        if (d.v.bSupported) {
            for (d.mode === "default" && sessionStorage.getItem("reViewMode") !==
                "core" && d.success(); b--;) a[b].style.display = "inline-block";
            ...
            for (screen.width >= 1200 && d.success(); b--;) a[b].style.display = "none"
    };
