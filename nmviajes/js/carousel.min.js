    ...
    function(t, e, o) {
        var i = {
            ...
            appendItemsSizes: function() {
                ...
                e.$owlItems.each(function (n) {
                    ...
                    s
                        .css({
                            "width": e.itemWidth,
                            "padding-right": e.options.padding
                        })
                        .data("owl-item", Number(n));

                    if (n % e.options.items === 0 || n === i) {
                        if (!(n > i)) {
                            o += 1;
                        }
                    }
            ...
            calculateWidth: function() {
                ...
                var t = this;
                t.itemWidth = Math.round( (t.$elem.width() + t.options.padding) / t.options.items);

                // console.log(t.$owlItems.width());
