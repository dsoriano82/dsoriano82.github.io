...
! function(t) {
    t.slidebars = function(s) {
        ...
        function n(t, s, e) {
            ...
            var a;
            if (a = t.hasClass("sb-style-push") ? g.add(t).add(O) : t.hasClass("sb-style-overlay") ? t : g.add(O), "translate" === x) "0px" === s ? n() : a.css("transform", "translate( " + s + " )" ) && a.css("animation-duration","0s") ;
